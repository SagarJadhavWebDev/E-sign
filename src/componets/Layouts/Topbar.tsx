...
const Topbar: React.FC<TopbarProps> = ({}) => {
  return (
    <nav className="bg-white w-full border shadow-2xl p-4  border-gray-200 px-2  ">
      <div className="container flex flex-wrap items-center justify-between ">
        ...
        {/* <div className="flex items-center md:order-2">
          <button
            type="button"
            className="flex mr-3 w-12 h-12  rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300"
            id="user-menu-button"
            aria-expanded="false"
          ...
          >
            ...
            <ul className="py-1" aria-labelledby="user-menu-button">
              ...
              <li>
                <a
                  href="#"
                  className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100   d"
                >
                  Settings
                </a>
              </li>
